...
// Актуальная версия для массивов
...
for (const file of files) {
    if (file === "cat.jpg") {
        //file = "cat.jpg2" ФАЙЛ ИЗМЕНИТСЯ ТОЛЬКО ВНУТРИ ЦИКЛА
...
//Чтобы изменить название файла в массиве мы должны обратиться к нему по индексу
//files[0] = "cat.jpg2"